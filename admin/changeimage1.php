...
if(isset($_POST['update'])){
	...
	$sql="update paket set img1 ='$image1' WHERE id ='$id'";
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal" enctype="multipart/form-data">
											...
											<label class="col-sm-4 control-label">Gambar Mobil  Sekarang</label>
												...
												?>
												<div class="col-sm-8">
													<img src="img/vehicleimages/<?php echo htmlentities($result['gambar']);?>" width="300" height="200" style="border:solid 1px #000">
												</div>
											<?php }?>
											</div>
