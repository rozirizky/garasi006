...
?>
          <ul>
            ...
            <li>
             ...
             <li>
              <div class="icon_wrap"><i class="fa fa-instagram" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="">@garasi006</a></div>
            </li>
             <li>
              <div class="icon_wrap"><i class="fa fa-instagram" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href=""></a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
